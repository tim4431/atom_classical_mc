...
Run from the repository root:
    ...
    python3 example/slm_to_aod_with_lensing.py

Saves a comparison plot next to this script.
"""
...
from src.analysis import bound_to_trap, single_trap_energy_uK  # noqa: E402
...
def run_one(label: str, dxdt2z: float):
    ...
    slm_trap = traps[0]
    config = build_config()
    result = run_simulation(traps, config)
